...
2. In the app's Python version settings, install the packages in `server_code/requirements.txt`: `mcp==2.2.0`, `e2b==2.51.0`, and `anyio==4.15.1`. Anvil supports installing packages through its app-specific requirements editor.
